...
function translateNonIntegerPart(number) {
  ...
  for (let i = number.length - 1; number[i] === "0"; i--) if (number[i - 1] !== "0") number = number.substring(0, i)
  ...
  const nonIntegerPartType =
    lastDigit === "1" && lastTwoDigits !== "11" ? NonIntegersPostfixes.ENDS_WITH_ONE : NonIntegersPostfixes.OTHERWISE
